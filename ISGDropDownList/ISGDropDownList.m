...
@interface ISGDropDownList()<UITableViewDataSource,UITableViewDelegate>
...
@implementation ISGDropDownList
#pragma mark - init
...
- (void)setupView {
    ...
    [dropArrow setImage:[UIImage imageNamed:[NSString stringWithFormat:@"ISGDropDownListImage.bundle/ISGDropdownImage.png"]] forState:UIControlStateNormal];
